...
/** 正确答  */
window.rigthAnswer = ' DCADD  A (BCE) CCB'
// window.rigthAnswer = ' DCADD  A (abc) CCB (deF)'
// window.rigthAnswer = ' DCADD  A （abc） CCB (deF)'
...
2. 李翠艳 BACDB A（ABC）CAB
3. 陈少芬 DBDDB A(BCE）CCB
4. 韦永新 CACAA  D(bcd)ACB
5. 温炳辉 CADDD A（BCE）CCB
6. 易江涛 DACBB A(BCE)AAB
7. 旭 CDADD  D（BCE）AAB
8. 刘思婷 CDC DB A(BCE）ACB
9. 亮亮 CACBDD(BCD)BDB
10. 治安 BCCBD A（ABE）CDD
11. 赵艳焜 DCADD A（ABC）CCD
12. 邱婉菡 AACBC D(BCD)BCB
13. 陈小棋 CDADB A（BCE）CCB
14. 林英 BACAD  D  (BCE) ACA
15. 于涛 BDADB D (ABC) CCA
16. 新 CCADD A(BCE)CCB
17. 黄雅君 DCADB D(BCE)CCB
18. 等等  BCCDB A(ABE)CCB
19. 谢成寿 Bdadb d(bce)aab
20. 钟洁莹 DBDDB  A（BCE）ACB
21. 陈庆娇 CDCDB D (ADE)ACB
22. 袁天赐 adaab d (bce) ccb
23. 莫德坚 DADAB  D(ABE)BCA
24. 阮晓梦 DAADB A(BCE)BCB
25. 汤燕婷 CCAAD A(BCE)ACB
26. 邹班庆 DDADA A(BCE)ACB
27. D_uende DCABB A(BCD)ACA
28. NICOLE DACBD A(BCE)CCB
29. 秦敏BCABB  C(BCE)BCB
30. 王鑫 CAAAB  A(BCE)ACB
31. 郑鸿斌 DCADB A(ABE)CCB
32. 陈妙玲 DAADD A(BCE)CCB
33. 胡林宇 BDAAA A(AE)BBA
34. 文博 BACDBA（ACE）CAB
35. 陈书婷 DDAAD D(BCE)ACB
36. 陈永发 DDADB A（BCE）ACB
37. jo an na BDADA A(ABE)ACB
38. 熊佳 BDCDD D(BCE)CCB
39. 洪俊鑫 DDCAD A(BCE)CAB
40. 李凯旋 DACDB、 D（ABC）ACA
41. 甘玉嫦 CDDAD （ABE）ACB
42. 李勇发 BACDD D (ACE) ACB
43. 陆婉仪 DAADD D(ABE)AAA
44. 郭晓丽 ACDDB D (BCE) CCB
45. 郑舒颖 DAADA A (BCE) BCB
